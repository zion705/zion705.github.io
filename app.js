...
const experiences = {
  xiaomi: {
    kicker: "Xiaomi / Product Innovation",
    title: "创新产品经理 · 小米",
    meta: "开源桌面宠物硬件 · C 端产品 0-1 | 2026/4 - 2026/7",
    points: [
      "【用户问题与产品定义】面向使用 Agent 工作的用户，识别长任务运行状态不可见的问题；将这一痛点转化为桌面宠物硬件方案，用动作与状态变化呈现运行、完成、异常和待干预反馈。",
      "【0-1 方案与落地】负责用户场景分析、需求拆解、功能设计和优先级判断，与软硬件研发团队协作，推动产品从交互原型进入实际落地；在多轮方案取舍中持续校准产品定位与核心体验。",
      "【开源后的反馈迭代】产品开源三周内获得 10 万+浏览和 3000+点赞收藏；结合评论、社群及外部用户反馈，重新调整用户定位和趣味互动功能，推动后续版本迭代。",
      "【工作方式提效】使用 AI Coding 快速搭建可交互原型、整理研究信息和验证方案，形成产品经理利用 AI 缩短探索与迭代周期的实践经验。"
    ],
    links: [
      {
        label: "开源硬件项目",
  ...
  baidu: {
    ...
    points: [
      "【定义理想态】围绕闲聊和角色扮演专项，通过用户调研、竞品调研与线上 Case 分析，梳理模型回复理想态，并将结论收敛为可执行的专项评估标准。",
      "【评估当前体验】基于评估集对主观能力进行量化评测，结合人工评估、问题标签和低分 Case 归因，判断模型当前问题及其影响范围。",
      "【策略推动优化】将评测发现转化为具体优化策略，与算法团队协作推进数据建设、训练前后盲评和模型迭代，平衡用户体验目标与研发可行性。",
      "【专项完整实践】参与俚语和网络用语能力提升，完成问题拆解、数据构建、策略设计与效果验证，加深了对 AI 产品经理基本工作流程和方法的认识。"
    ]
  },
  buding: {
    kicker: "C-end Startup / Buding",
    title: "C 端产品经理 · 扩散未来",
    meta: "北京扩散未来科技有限公司 | 2024/12 - 2025/3",
    points: [
      "【产品负责人】负责动态表情包小程序从用户需求分析、MVP 验证、产品方案、PRD/原型到上线验收和早期运营的完整闭环；产品获得 200+ 新增用户和 13 位首次付费用户。",
  ...
  telestudio: {
    ...
    intro:
      "负责 C 端内容创作平台 TeleStudio 的实时数字人功能上线，完成需求梳理、产品方案和核心 PRD，并参与数字人竞品调研与视频效果评测。",
