...
const experiences = {
  xiaomi: {
    ...
    points: [
      ...
      "【AI-native 产品化】围绕自定义宠物形象形成三层变化：用 Codex 自动化工作流批量生成并校验动画资产，替代逐个动作手工生产；产品经理直接交付可运行前端与关键生成规则，缩短与 RD 的协作链路；产品形态从 App 内 GUI 延伸为 Agent 可调用的 Skill，完成自然语言描述、资产生成、规范校验、预览与安装。",
